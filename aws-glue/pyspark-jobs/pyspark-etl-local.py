...
import findspark
findspark.init('/Users/troy/server/spark-2.4.6-bin-hadoop2.7')
...
output_dir_path = "../../ecommerce-funnel-data/output/"
...
input_file_path = "../../ecommerce-funnel-data/2016_funnel.csv"
